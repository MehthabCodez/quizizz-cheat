...
```ts
fetch("https://raw.githubusercontent.com/MehthabCodez/quizizz-cheat/master/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
...
```ts
fetch("https://raw.githubusercontent.com/MehthabCodez/quizizz-cheat/oldmethod/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
